...
import edu.mum.cs.cs472.lab11.daos.NewResponse;
...
//            response.sendRedirect(redirectUrl);
        	...
        	ContactFormData newData = new ContactFormData(customerName, gender, category, message);
        	NewResponse ob = new NewResponse();
        	ob.addResponse(newData);
