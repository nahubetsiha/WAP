...
<header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            ...
            <form class="form-inline my-2 my-lg-0" action="SearchPageController">
                <input class="form-control mr-sm-2" type="text" name="input" title="Search using name" placeholder="Search">
